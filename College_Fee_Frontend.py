...
class college_fee():
    def __init__(self, master):
        self.master = master
        self.master.title('Fees Report')
        self.master.state('zoomed')
        self.master.config(bg='#28B5B5')
        ...
        College_Main_Frame = Frame(self.master, bg='#28B5B5')
        College_Main_Frame.grid()

        College_Title_Frame = LabelFrame(
            College_Main_Frame, width=1350, height=100, bg='#28B5B5', relief='ridge', bd=15)
        College_Title_Frame.pack(side=TOP)

        self.lblTitle = Label(College_Title_Frame, font=('arial', 40, 'bold'), text='FEES REPORT',
                              bg='#28B5B5', padx=13)
        self.lblTitle.grid(padx=400)

        College_Data_Frame = Frame(College_Main_Frame, width=1350, height=350,
                           bg='#28B5B5', relief='ridge', bd=15)
        College_Data_Frame.pack(side=TOP, padx=15)

        College_Frame_1 = LabelFrame(College_Data_Frame, width=850, height=350, bg='#28B5B5', relief='ridge', bd=8,
                             text='Informations', font=('arial', 15, 'bold'))
        College_Frame_1.pack(side=LEFT, padx=10)

        College_Frame_2 = LabelFrame(College_Data_Frame, width=495, height=350, bg='#28B5B5', relief='ridge', bd=8,
        ...
        exit_label = Button(root, text="Dashbord", font=('Ink Free', 15), bg="#d2e603", fg="black", command=out)
