...
con = sqlite3.connect("Placement_info_New.db")
base = Tk()
base.state("zoomed")
base.title("Placement Management System")
...
def event1():
    ...
    con = sqlite3.connect("Placement_info_New.db")
    q = "insert into Placement_info values('" + a + "'," + b + ",'" + c + "','" + d + "',"+ e +"," + f +"," + g+ ",'"+h+"','"+i+"','"+j+"',"+k+",'"+l+"',"+m+",'"+n+"')"
    con.execute(q)
    con.commit()
    con.close()
...
def event3():
    ...
    con = sqlite3.connect("Placement_info_New.db")
    q = "update Placement_info set Name='" + a + "',Email='" + c + "',Gender='" + d + "',StudentContact="+e+",DOB="+f+",PRN="+g+",Branch='"+h+"',CurrentYear="+i+",Division='"+j+"',ParentContact="+k+",CompanyName='"+l+"',Pakage="+m+",Address='"+n+"' where Roll=" + b
    con.execute(q)
    con.commit()
    con.close()
...
def event4():
          b = str(t2.get())
          con = sqlite3.connect("Placement_info_New.db")
          q ="delete from Placement_info where Roll="+b
          con.execute(q)
          con.commit()
          con.close()
...
title=Label(base,text="Placement Management System",bd=10,relief=GROOVE,font=("times new roman", 30,"bold"),bg="#4B778D",fg="Black")
...
l1 = Label(Man_fr1,text="Sudent Name",font=("Calisto MT", 18),bg="#28B5B5",fg="black")
l1.place(x=30,y=80)
...
l2 = Label(Man_fr1,text="Roll No.",font=("Calisto MT", 18),bg="#28B5B5",fg="black")
l2.place(x=30,y=120)
...
l3 = Label(Man_fr1,text="Email-id",font=("Calisto MT", 18),bg="#28B5B5",fg="black")
l3.place(x=30,y=160)
...
l4 = Label(Man_fr1,text="Gender",font=("Calisto MT", 18),bg="#28B5B5",fg="black")
l4.place(x=30,y=200)
...
l5 = Label(Man_fr1,text="Student's Contact No",font=("Calisto MT", 18),bg="#28B5B5",fg="black")
l5.place(x=30,y=240)
...
l6 = Label(Man_fr1,text="D.O.B.",font=("Calisto MT", 18),bg="#28B5B5",fg="black")
l6.place(x=30,y=280)
...
l7 = Label(Man_fr1,text="PRN No",font=("Calisto MT", 18),bg="#28B5B5",fg="black")
l7.place(x=30,y=320)
...
l8 = Label(Man_fr1,text="Branch",font=("Calisto MT", 18),bg="#28B5B5",fg="black")
l8.place(x=30,y=360)

t8= Entry(Man_fr1,font=("Calisto MT", 15),fg="black")
t8.place(x=300,y=360,width=250)

l9 = Label(Man_fr1,text="Current Year",font=("Calisto MT", 18),bg="#28B5B5",fg="black")
l9.place(x=30,y=400)
...
l10 = Label(Man_fr1,text="Division",font=("Calisto MT", 18),bg="#28B5B5",fg="black")
...
l11 = Label(Man_fr1,text="Parent's Contact No",font=("Calisto MT", 18),bg="#28B5B5",fg="black")
...
l12 = Label(Man_fr1,text="Company Name",font=("Calisto MT", 18),bg="#28B5B5",fg="black")
...
l13 = Label(Man_fr1,text="Package",font=("Calisto MT", 18),bg="#28B5B5",fg="black")
l13.place(x=30,y=560)

t13=Entry(Man_fr1,font=("Calisto MT", 15),fg="black")
t13.place(x=300,y=560,width=250)

l14 = Label(Man_fr1,text="Address",font=("Calisto MT", 18),bg="#28B5B5",fg="black")
l14.place(x=30,y=600)

t14=Entry(Man_fr1,font=("Calisto MT", 15),fg="black")
t14.place(x=300,y=600,width=250)
...
def search_Student():
    for widget in dt_fr1.winfo_children():
        widget.destroy()
    s_roll = str(ta1.get())
    query = f"select Name,Roll,Email,Gender,StudentContact,DOB,PRN,Branch,CurrentYear,Division,ParentContact,CompanyName,Pakage,Address from Placement_info where Roll={s_roll}"
    cur = con.cursor()
    cur.execute(query)
    con.commit()
    data = cur.fetchone()
    ...
    if data is None:
        ...
        StudentContact = Label(dt_fr1, text=f"StudentContact: {data[4]}", font=("Calisto MT", 20),bg="#EDFFEC",fg="black")
        ...
        CurrentYear = Label(dt_fr1, text=f"CurrentYear: {data[8]}", font=("Calisto MT", 20),bg="#EDFFEC",fg="black")
        ...
        ParentContact = Label(dt_fr1, text=f"ParentContact: {data[10]}", font=("Calisto MT", 20),bg="#EDFFEC",fg="black")
        ParentContact.place(x=70, y=410)

        Address = Label(dt_fr1, text=f"CompanyName: {data[11]}", font=("Calisto MT", 20),bg="#EDFFEC",fg="black")
        Address.place(x=70, y=440)

        Address = Label(dt_fr1, text=f"Pakage: {data[12]}", font=("Calisto MT", 20), bg="#EDFFEC", fg="black")
        Address.place(x=70, y=480)

        Address = Label(dt_fr1, text=f"Address: {data[13]}", font=("Calisto MT", 20), bg="#EDFFEC", fg="black")
        Address.place(x=70, y=520)


bt11= Button(dt_fr2,text="Search",font=("times new roman", 20,"bold"),command=search_Student,bg="#D2E603",fg="black")
