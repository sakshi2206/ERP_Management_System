...
def marking_sheet():
       ...
       Marks_Frame_4 = LabelFrame(root, width=400, height=550, font=('arial', 20, 'bold'), bg='#EDFFEC', bd=10 \
                                  , text='Any', relief='ridge')
       Marks_Frame_4.place(x=1100, y=250)




       Marks_Frame_1 = LabelFrame(root, width = 300, height = 400, font = ('arial',20,'bold'), bg = '#EDFFEC', bd = 10, \
                            text = 'Student Details', relief = 'ridge')
       Marks_Frame_1.grid(row = 1, column = 0, pady = 20, padx = 0)
...
def search_result_marksheet(row):
       ...
       Marks_Frame_3 = LabelFrame(root, width=1200, height=400, font=('arial', 20, 'bold'), bg='#EDFFEC', bd=10 \
                                  , text='Any', relief='ridge')
       Marks_Frame_3.grid(row=3, column=0)
       root.mainloop()
