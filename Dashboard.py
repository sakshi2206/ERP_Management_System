...
def Marksheet():
    ...
    def marking_sheet():
        ...
        def Add():
            if (len(roll.get()) != 0):
                College_Marksheet_Backend.insert(name.get(), roll.get(), father_name.get(), mother_name.get(),
                                                 date_of_birth.get(), gender.get(), \
        ...
        def Update():
            if (len(roll.get()) != 0):
                College_Marksheet_Backend.update(name.get(), roll.get(), father_name.get(), mother_name.get(),
                                                 date_of_birth.get(), gender.get(), \
                                                 school.get(), email_address.get(), marks1.get(), marks2.get(),
                                                 marks3.get(), marks4.get(), marks5.get(), \
                                                 grand_tot.get(), percentage.get(), cgpa.get(), grade.get(),
        ...
        Marks_Frame_1 = LabelFrame(root, width=1200, height=400, font=('arial', 20, 'bold'), bg='#EDFFEC', bd=10, \
                                   text='Student Details', relief='ridge')
        Marks_Frame_1.grid(row=1, column=0, pady=20, padx=20)

        Name_lbl = Label(Marks_Frame_1, text='Name', font=('arial', 15, 'bold'), bg='#EDFFEC')
        ...
        RollNumber_lbl = Label(Marks_Frame_1, text='Roll Number', font=('arial', 15, 'bold'), bg='#EDFFEC')
        ...
        fname_lbl = Label(Marks_Frame_1, text='Father Name', font=('arial', 15, 'bold'), bg='#EDFFEC')
        ...
        mname_lbl = Label(Marks_Frame_1, text='Mother Name', font=('arial', 15, 'bold'), bg='#EDFFEC')
        ...
        dateOFbirth_lbl = Label(Marks_Frame_1, text='Date of Birth', font=('arial', 15, 'bold'), bg='#EDFFEC')
        ...
        gender_lbl = Label(Marks_Frame_1, text='Gender', font=('arial', 15, 'bold'), bg='#EDFFEC')
        gender_lbl.grid(row=2, column=3, padx=80)
        gender_txtEntry = ttk.Combobox(Marks_Frame_1, values=(' ', 'Male', 'Female', 'Others'), font=('arial', 15),
                                       width=23, textvariable=gender)
        gender_txtEntry.grid(row=2, column=4, padx=5, pady=5)

        school_lbl = Label(Marks_Frame_1, text='School Name', font=('arial', 15, 'bold'), bg='#EDFFEC')
        ...
        emailAddress_lbl = Label(Marks_Frame_1, text='Email ID', font=('arial', 15, 'bold'), bg='#EDFFEC')
        ...
        Marks_Frame_2 = LabelFrame(root, width=1200, height=400, font=('arial', 20, 'bold'), bg='#EDFFEC', bd=10 \
                                   , text='Grades Point Obtained', relief='ridge')
        Marks_Frame_2.grid(row=3, column=0)

        subject_lbl = Label(Marks_Frame_2, text='SUBJECT', font=('arial', 16, 'bold'), bg='#EDFFEC')
        subject_lbl.grid(row=3, column=0, padx=50, pady=10)

        marks_obtained_lbl = Label(Marks_Frame_2, text='MARKS OBTAINED', font=('arial', 16, 'bold'), bg='#EDFFEC')
        marks_obtained_lbl.grid(row=3, column=1, padx=20)

        subject_lbl = Label(Marks_Frame_2, text='PASSING MARKS', font=('arial', 16, 'bold'), bg='#EDFFEC')
        subject_lbl.grid(row=3, column=2, padx=20)

        marks_obtained_lbl = Label(Marks_Frame_2, text='TOTAL MARKS', font=('arial', 16, 'bold'), bg='#EDFFEC')
        marks_obtained_lbl.grid(row=3, column=3, padx=20)

        MATHEMATICS_lbl1 = Label(Marks_Frame_2, text='MATHEMATICS', font=('arial', 14), bg='#EDFFEC')
        MATHEMATICS_lbl1.grid(row=4, column=0)
        PHYSICS_lbl2 = Label(Marks_Frame_2, text='PHYSICS', font=('arial', 14), bg='#EDFFEC')
        PHYSICS_lbl2.grid(row=5, column=0)
        CHEMISTRY_lbl3 = Label(Marks_Frame_2, text='CHEMISTRY', font=('arial', 14), bg='#EDFFEC')
        CHEMISTRY_lbl3.grid(row=6, column=0)
        PROGRAMMING_lbl4 = Label(Marks_Frame_2, text='PROGRAMMING', font=('arial', 14), bg='#EDFFEC')
        PROGRAMMING_lbl4.grid(row=7, column=0)
        ENGLISH_lbl5 = Label(Marks_Frame_2, text='ENGLISH', font=('arial', 14), bg='#EDFFEC')
        ENGLISH_lbl5.grid(row=8, column=0)
        GRAND_TOTAL_lbl6 = Label(Marks_Frame_2, text='GRAND TOTAL', font=('arial', 16), bg='#EDFFEC')
        GRAND_TOTAL_lbl6.grid(row=9, column=0)
        PERCENTAGE_lbl7 = Label(Marks_Frame_2, text='PERCENTAGE', font=('arial', 16, 'bold'), bg='#EDFFEC')
        PERCENTAGE_lbl7.grid(row=10, column=0)
        CGPA_lbl8 = Label(Marks_Frame_2, text='CGPA', font=('arial', 16, 'bold'), bg='#EDFFEC')
        CGPA_lbl8.grid(row=10, column=2)
        GRADE_lbl9 = Label(Marks_Frame_2, text='GRADE', font=('arial', 16, 'bold'), bg='#EDFFEC')
        GRADE_lbl9.grid(row=10, column=4)
        DIVISION_lbl10 = Label(Marks_Frame_2, text='DIVISION', font=('arial', 16, 'bold'), bg='#EDFFEC')
        DIVISION_lbl10.grid(row=11, column=0)
        DIVISION_lbl10 = Label(Marks_Frame_2, text='RESULT', font=('arial', 16, 'bold'), bg='#EDFFEC')
        ...
        Text_Entry7 = Entry(Marks_Frame_2, font=('arial', 14, 'bold'), width=5, textvariable=percentage,
                            state='readonly')
        ...
        Text_Entry10 = Entry(Marks_Frame_2, font=('arial', 14, 'bold'), width=8, textvariable=division,
                             state='readonly')
        ...
        Compute_button = Button(root, text='COMPUTE', font=('arial', 12, 'bold'), bg="#D2E603", width=10,
                                command=Compute)
        Compute_button.place(x=300, y=700)
        Save_button = Button(root, text='SAVE', font=('arial', 12, 'bold'), bg="#D2E603", width=10, command=Add)
        Save_button.place(x=450, y=700)
        Update_button = Button(root, text='UPDATE', font=('arial', 12, 'bold'), bg="#D2E603", width=10, command=Update)
        Update_button.place(x=600, y=700)
        Cancel_button = Button(root, text='RESET', font=('arial', 12, 'bold'), bg="#D2E603", width=10, command=Reset)
        Cancel_button.place(x=750, y=700)
        Exit_button = Button(root, text='EXIT', font=('arial', 12, 'bold'), bg="#D2E603", width=10, command=Exit)
        Exit_button.place(x=750, y=700)
...
Menu_title_Frame = LabelFrame(root, font=('arial', 50, 'bold'), width=1000, height=100, bg="#D2E603",
                              relief='raise', bd=13)
Menu_title_Frame.grid(row=0, column=0, pady=50)

Menu_title_Label = Label(Menu_title_Frame, text='MENU', font=('arial', 30, 'bold'), bg="#D2E603" )
Menu_title_Label.grid(row=0, column=0, padx=200)

# ========================================================FRAMES===================================================================
Menu_Frame_1 = LabelFrame(root, font=('arial', 17, 'bold'), width=1000, height=100, bg="#BAE5E5", relief='ridge',
                          bd=10)
Menu_Frame_1.grid(row=1, column=0, padx=280)
Menu_Frame_2 = LabelFrame(root, font=('arial', 17, 'bold'), width=1000, height=100, bg="#BAE5E5", relief='ridge',
                          bd=10)
Menu_Frame_2.grid(row=2, column=0, padx=130, pady=7)
Menu_Frame_3 = LabelFrame(root, font=('arial', 17, 'bold'), width=1000, height=100, bg="#BAE5E5", relief='ridge',
                          bd=10)
Menu_Frame_3.grid(row=3, column=0, pady=7)
Menu_Frame_4 = LabelFrame(root, font=('arial', 17, 'bold'), width=1000, height=100, bg="#BAE5E5", relief='ridge',
                          bd=10)
Menu_Frame_4.grid(row=4, column=0, pady=7)

Menu_Frame_5 = LabelFrame(root, font=('arial', 17, 'bold'), width=1000, height=100, bg="#BAE5E5", relief='ridge',
                          bd=10)
Menu_Frame_5.grid(row=5, column=0, pady=7)
Menu_Frame_6 = LabelFrame(root, font=('arial', 17, 'bold'), width=1000, height=100, bg="#BAE5E5", relief='ridge',
                          bd=10)
Menu_Frame_6.grid(row=6, column=0, pady=7)



# ========================================================LABELS===================================================================
Label_1_STUDENTINFO = Label(Menu_Frame_1, text='STUDENT MANAGEMENT', font=('arial', 25, 'bold'), bg="#BAE5E5")
Label_1_STUDENTINFO.grid(row=0, column=0, padx=150, pady=5)
Label_2_FEEREPORT = Label(Menu_Frame_2, text='FEES MANAGEMENT', font=('arial', 25, 'bold'), bg="#BAE5E5")
Label_2_FEEREPORT.grid(row=0, column=0, padx=200, pady=5)
Label_3_LIBRARYSYSTEM = Label(Menu_Frame_3, text='LIBRARY MANAGEMENT', font=('arial', 25, 'bold'), bg="#BAE5E5")
Label_3_LIBRARYSYSTEM.grid(row=0, column=0, padx=160, pady=5)
Label_4_MARKSHEET = Label(Menu_Frame_4, text='STUDENT MARKSHEET', font=('arial', 25, 'bold'), bg="#BAE5E5")
Label_4_MARKSHEET.grid(row=0, column=0, padx=173, pady=5)

Label_5_MARKSHEET = Label(Menu_Frame_5, text='FACULTY MANAGEMENT', font=('arial', 25, 'bold'), bg="#BAE5E5")
Label_5_MARKSHEET.grid(row=0, column=0, padx=163, pady=5)

Label_6_MARKSHEET = Label(Menu_Frame_6, text='PLACEMENT MANAGEMENT', font=('arial', 25, 'bold'), bg="#BAE5E5")
Label_6_MARKSHEET.grid(row=0, column=0, padx=141, pady=5)
...
# ========================================================BUTTONS===================================================================
Button_1_VIEWINFO = Button(Menu_Frame_1, text='VIEW', font=('arial', 16, 'bold'),bg="#D2E603", width=8,command=StudentManagement)
Button_1_VIEWINFO.grid(row=0, column=3, padx=50)
Button_2_VIEWREPORT = Button(Menu_Frame_2, text='VIEW', font=('arial', 16, 'bold'),bg="#D2E603", width=8,command=FeesManagement)
Button_2_VIEWREPORT.grid(row=0, column=3, padx=50)
Button_3_VIEWLIBRARY = Button(Menu_Frame_3, text='VIEW', font=('arial', 16, 'bold'),bg="#D2E603", width=8,command=Lab)
Button_3_VIEWLIBRARY.grid(row=0, column=3, padx=50)
Button_4_VIEWMARKSHEET = Button(Menu_Frame_4, text='VIEW', font=('arial', 16, 'bold'),bg="#D2E603", width=8,command=Marksheet)
Button_4_VIEWMARKSHEET.grid(row=0, column=3, padx=50)
Button_5_VIEWMARKSHEET = Button(Menu_Frame_5, text='VIEW', font=('arial', 16, 'bold'),bg="#D2E603", width=8,command=Faculty_Management)
Button_5_VIEWMARKSHEET.grid(row=0, column=3, padx=50)
Button_6_VIEWMARKSHEET = Button(Menu_Frame_6, text='VIEW', font=('arial', 16, 'bold'),bg="#D2E603", width=8,command=Placement_Management)
Button_6_VIEWMARKSHEET.grid(row=0, column=3, padx=50)

Button_7_VIEWMARKSHEET = Button( root,text='EXIT', font=('arial', 16, 'bold'),bg="#D2E603", width=8,command=Exit)
Button_7_VIEWMARKSHEET.place(x=700,y=700)
